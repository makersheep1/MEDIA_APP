...
void MusicWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MusicWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MusicWindow::backRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MusicWindow::backRequested()
{
